...
export interface IRollupPluginAccessorHooks {
     ...
     */
    readonly onGetWatchOptions: AsyncSeriesWaterfallHook<RollupWatchOptions, Readonly<IRollupConfiguration>, never>;
}
/**
 * @public
 */
 ...
 * @public
 */
export declare const PLUGIN_NAME: 'rollup-plugin';
